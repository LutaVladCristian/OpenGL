...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.9f, 0.1f, 0.2f));
    }

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.8f, 1.0f, 0.2f));
    }

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.6f, 0.3f, 0.3f));
    }
    ...
    // Render ground
    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0.0f, 0.7f, 0.5f));
    }
...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    GLint material_shininess = glGetUniformLocation(shader->GetProgramID(), "material_shininess");
    glUniform1i(material_shininess, materialShininess);

    GLint material_kd = glGetUniformLocation(shader->GetProgramID(), "material_kd");
    glUniform1f(material_kd, materialKd);

    GLint material_ks = glGetUniformLocation(shader->GetProgramID(), "material_ks");
    glUniform1f(material_ks, materialKs);

    GLint object_color = glGetUniformLocation(shader->GetProgramID(), "object_color");
